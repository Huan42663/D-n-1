<?php
function add_bill ($firstname,$lastname,$tel,$address,$date,$payment,$id_user,$totals,$voucher_discount){
    $full_name = $firstname ." ". $lastname;
    $sql = "INSERT INTO BILL (NAME_USER,TEL_USER,ADDRESS_USER,DATE,TOTAL,PAYMENT,VOUCHER_DISCOUNT,STATUS,ID_USER) 
