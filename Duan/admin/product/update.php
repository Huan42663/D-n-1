                            ...
                            <form class="form-valide" action="index.php?act=updated_pro" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-xl-6">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="val-username">Giá Khuyến Mại
                                                <span class="text-danger">*</span>
                                            </label>
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-username" name="discount" placeholder="Enter a discount..." value="<?=$discount?>">
                                            </div>
                                        </div>
