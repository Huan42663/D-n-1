            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Danh Sách Đơn Hàng Chưa Xác Nhận</h4>
                    </div>
                    <div class="card-body">
                        ...
                        <span>
                            ...
                            ?>
                            <a class="paginate_button current" href="index.php?act=list_order&page-ucb=<?=$i?>" aria-controls="example" data-dt-idx="1" tabindex="0"><?=$i+1?></a>
                            <?php
                                }
                            ?>
                        </span>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Danh Sách Đơn Hàng Đã Xác Nhận</h4>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <?php
                            ...
                            <div class="list-infor-order">
                                ...
                                ?>
                                    <li class="list-group-item d-flex justify-content-between">
                                        <a href="index.php?act=change_status_bill&id=<?=$id_bill?>"><button>Hoàn Thành Đơn Hàng</button></a>
                                    </li>
                                <?php
                                    }
                                ?>
                        ...
                        <span>
                            ...
                            ?>
                            <a class="paginate_button current" href="index.php?act=list_order&page-cb=<?=$i?>" aria-controls="example" data-dt-idx="1" tabindex="0"><?=$i+1?></a>
                            <?php
                                }
                            ?>
                        </span>
