          ...
          <ul class="metismenu" id="menu">
            ...
            <li>
              <a
                ...
                ><span class="nav-text">Bảng Điều Khiển</span></a
              >
            ...
            <li>
              <a
                ...
                ><span class="nav-text">Biểu Đồ Thống Kê</span></a
              >
            ...
            <li>
              <a
                ...
                ><span class="nav-text">Danh Mục</span></a
              >
              <ul aria-expanded="false">
            ...
            <li>
                <a
                  ...
                  aria-expanded="false"
                  ><i class="icon icon-world-2"></i
                  ><span class="nav-text">Sản Phẩm</span></a
                >
                <ul aria-expanded="false">
              ...
              <li>
                <a
                  ...
                  aria-expanded="false"
                  ><i class="icon icon-world-2"></i
                  ><span class="nav-text">Đơn Hàng</span></a
                >
                <ul aria-expanded="false">
            ...
            <li class="nav-label">Quản Lý Khách Hàng</li>
              <li>
                <a
                  ...
                  aria-expanded="false"
                  ><i class="icon icon-world-2"></i
                  ><span class="nav-text">Người Dùng</span></a
                >
                <ul aria-expanded="false">
            ...
            <li>
                <a
                  ...
                  aria-expanded="false"
                  ><i class="icon icon-world-2"></i
                  ><span class="nav-text">Danh Sách Đơn Hàng</span></a
                >   
              </li>  
              ...
              <li>
                <a
                  ...
                  aria-expanded="false"
                  ><i class="icon icon-world-2"></i
                  ><span class="nav-text">Đơn Hàng Đã Nhận</span></a
                >   
              </li>  
              ...
              <li>
                <a
                  ...
                  aria-expanded="false"
                  ><i class="icon icon-world-2"></i
                  ><span class="nav-text">Đơn Hàng Đã Giao</span></a
                >   
              </li>  
